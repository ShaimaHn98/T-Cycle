...
CardView card_order;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
       ...
       if (pr_of_iron != null)
           holder.pr_iron(pr_of_iron);

       if (pr_of_pla != null)
            holder.pr_pla(pr_of_pla);

       if (pr_of_alm != null)
            holder.pr_alm(pr_of_alm);
...
Button btn_date;
        ...
        public void pr_copper( String copper){
